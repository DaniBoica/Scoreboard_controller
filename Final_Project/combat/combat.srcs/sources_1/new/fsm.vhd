...
type states is(idle, countUpT1 ,countDwT1, countUpT2, countDwT2, reset, update_display);

signal current_state,next_state: states;
signal incrementT1, decrementT1, incrementT2, decrementT2: std_logic;
signal waitPeriod: std_logic;
...
process (current_state, btn_db)
    begin
      case current_state is
        ...
        when countUpT1 => next_state <= update_display;
        when countUpT2 => next_state <= update_display;
        when countDwT1 => next_state <= update_display;
        when countDwT2 => next_state <= update_display;
        when update_display => next_state <= idle;
